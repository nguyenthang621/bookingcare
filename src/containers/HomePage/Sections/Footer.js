        ...
        return (
            <div className="footer-container">
                            ...
                            <div class="container-footer py-4">
                                <div class="row gy-4 gx-5">
                                    <div class="infor-footer col-lg-5 col-md-6">
                                        ...
                                        <div className="dk">
                                            <IoCheckmarkSharp /> ĐKKD số: 0106790291. Sở KHĐT Hà Nội cấp ngày 16/03/2015
                                        </div>
                                ...
                                <div className="download-app">
                                    ...
                                    <IoPhonePortraitOutline />
                                    <p>
                                        Tải ứng dụng BookingCare cho điện thoại hoặc máy tính bảng: Android iPhone/iPad
                                        Khác
                                    </p>
                                </div>
                            </div>
                ...
                <div className="footer-down">
                    <div className="content-footer coverArea">
